    ...
    <nav x-data="{ open: false }" class="navbar-gradient sticky top-0 z-50 shadow-md">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="login.php" class="bg-[#522b05] text-white px-6 py-2 rounded-full font-bold hover:bg-[#3d1f03] hover:scale-105 transition-all duration-300">
                    Pesan Sekarang
                </a>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                <div class="bg-white rounded-3xl shadow-xl overflow-hidden hover:-translate-y-3 transition-transform duration-300 flex flex-col">
                    ...
                    <div class="p-8 text-center flex-grow flex flex-col justify-between">
                        ...
                        <a href="pesan.php" class="bg-[#d63384] text-white py-3 rounded-2xl font-bold hover:bg-pink-700 transition shadow-md">Pesan</a>
                    </div>
                </div>
                <div class="bg-white rounded-3xl shadow-xl overflow-hidden hover:-translate-y-3 transition-transform duration-300 flex flex-col">
                ...
                <div class="bg-white rounded-3xl shadow-xl overflow-hidden hover:-translate-y-3 transition-transform duration-300 flex flex-col">
                    <img src="https://i.pinimg.com/736x/f3/df/fa/f3dffaf7d5db005674918708092764f8.jpg" class="w-full h-64 object-cover" alt="Putri Salju">
                    <div class="p-8 text-center flex-grow flex flex-col justify-between">
                        <div>
        ...
        <div class="container mx-auto px-6 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                <div class="bg-white p-8 rounded-3xl shadow-md">
                    ...
                    <p class="text-gray-600">Jl. Manis No. 123, Kota Bandung</p>
                </div>
                <div class="bg-white p-8 rounded-3xl shadow-md">
            ...
            <a href="https://wa.me/628123456789" class="inline-flex items-center gap-3 mt-12 bg-green-600 text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-green-700 transition shadow-lg">
